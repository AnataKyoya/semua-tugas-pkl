...
<body>
    ...
    <div style="max-width:900px;margin:0 auto;padding:32px 20px 60px;">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:36px;">
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <span class="mono" style="font-size:18px;font-weight:700;">BMC<span
        ...
        <div style="display:flex;flex-direction:column;gap:20px;">
            ...
            <div class="panel" id="results-area"
                ...
                <div id="empty-state"
                    ...
                    <p class="mono" id="state-status" style="font-size:12px;color:var(--muted);">Waiting for execution
                        command...</p>
                </div>
    ...
    <script>
            ...
            try {
                const response = await fetch(API_ENDPOINT, {
                    ...
                    body: JSON.stringify({
                        ...
                        xyz_abc: 'user_999' // ganti dengan nilai user_id yang sesuai, misal dari session/localStorage
                    })
                });
                ...
                while (true) {
                    ...
                    for (const line of lines) {
                        if (line.startsWith('RAW:')) {
                            ...
                            // loadFromDB('user_999'); // refresh sidebar otomatis
        ...
        async function loadFromDB(user) {
            const API = `<?= base_url() ?>bmc/result/${user}`;
            ...
            try {
                ...
                document.getElementById('state-status').innerHTML = err.message;
                document.getElementById('loading-state').style.display = 'none';
